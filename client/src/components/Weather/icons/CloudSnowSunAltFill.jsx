     import React from 'react';     export default () => (     <svg version="1.1" id="cloudSnowSunAltFill" className="climacon climacon_cloudSnowSunAltFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudSnowSunAltFill">
            ...
            <g className="climacon_wrapperComponent climacon_wrapperComponent-snowAlt">
                <g className="climacon_component climacon_component climacon_component-snowAlt">
                    ...
                    />
                    <circle className="climacon_component climacon_component-fill climacon_component-fill_snowAlt" fill="#FFFFFF" cx="50" cy="63.641"
                        r="2" />
                </g>
            </g>
