     import React from 'react';     export default () => (     <svg version="1.1" id="cloudFogMoonFill" className="climacon climacon_cloudFogMoonFill" xmlns="http://www.w3.org/2000/svg" viewBox="15 15 70 70">
