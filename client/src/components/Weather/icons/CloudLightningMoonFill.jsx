     import React from 'react';     export default () => (     <svg version="1.1" id="cloudLightningMoonFill" className="climacon climacon_cloudLightningMoonFill" viewBox="15 15 70 70">
