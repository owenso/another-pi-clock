 ...
 export default () => (        
    <svg version="1.1" id="sunsetAlt" className="climacon climacon_snowflake" viewBox="15 15 70 70">
        ...
        <g className="climacon_iconWrap climacon_iconWrap-snowflake">
            <g className="climacon_componentWrap climacon_componentWrap-snowflake" clipPath="url(#snowflakeFillClip)">
