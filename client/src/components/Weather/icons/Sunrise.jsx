     import React from 'react';     export default () => (     <svg version="1.1" id="sunrise" className="climacon climacon_sunrise" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-sunrise">
            <g className="climacon_componentWrap climacon_componentWrap-sunrise">
                ...
                <g className="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
                    <path className="climacon_component climacon_component-stroke climacon_component-stroke_sunBody" d="M50.001,44.002c-6.627,0-11.999,5.371-11.999,11.998c0,1.404,0.254,2.747,0.697,3.999h4.381c-0.683-1.177-1.079-2.54-1.079-3.999c0-4.418,3.582-7.999,8-7.999c4.417,0,7.998,3.581,7.998,7.999c0,1.459-0.396,2.822-1.078,3.999h4.381c0.443-1.252,0.697-2.595,0.697-3.999C61.999,49.373,56.627,44.002,50.001,44.002z"
                    />
                </g>
                <g className="climacon_wrapperComponent climacon_wrapperComponent-arrow">
                    <path className="climacon_component climacon_component-stroke climacon_component-stroke_arrow climacon_component-stroke_arrow-up"
                ...
                <g className="climacon_wrapperComponent climacon_wrapperComponent-horizonLine">
                    <path className="climacon_component climacon_component-stroke climacon_component-stroke_horizonLine" d="M59.999,63.999H40.001c-1.104,0-1.999,0.896-1.999,2s0.896,1.999,1.999,1.999h19.998c1.104,0,2-0.895,2-1.999S61.104,63.999,59.999,63.999z"
                    />
                </g>
            </g>
        </g>
