     import React from 'react';     export default () => (     <svg version="1.1" id="cloudDrizzleMoonFillAlt" className="climacon climacon_cloudDrizzleMoonFillAlt" viewBox="15 15 70 70">
