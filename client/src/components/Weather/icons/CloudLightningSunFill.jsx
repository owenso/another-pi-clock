 import React from 'react';     export default () => (     <svg version="1.1" id="cloudLightningSunFill" className="climacon climacon_cloudLightningSunFill" viewBox="15 15 70 70">
        ...
        <g className="climacon_iconWrap climacon_iconWrap-cloudLightning">
            ...
            <g className="climacon_wrapperComponent climacon_wrapperComponent-lightning">
                <polygon className="climacon_component climacon_component-stroke climacon_component-stroke_lightning" points="48.001,51.641 57.999,51.641 52,61.641 58.999,61.641 46.001,77.639 49.601,65.641 43.001,65.641 "
                />
            </g>
