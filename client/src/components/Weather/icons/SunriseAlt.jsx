     import React from 'react';     export default () => (     <svg version="1.1" id="sunriseAlt" className="climacon climacon_sunriseAlt" viewBox="15 15 70 70">
