     import React from 'react';     export default () => (     <svg version="1.1" id="cloudDrizzleSunFillAlt" className="climacon climacon_cloudDrizzleSunFillAlt" viewBox="15 15 70 70">
