     import React from 'react';     export default () => (     <svg version="1.1" id="sunset" className="climacon climacon_sunset" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-sunset">
            <g className="climacon_componentWrap climacon_componentWrap-sunset">
                ...
                <g className="climacon_wrapperComponent climacon_wrapperComponent-arrow">
                    <path className="climacon_component climacon_component-stroke climacon_component-stroke_arrow climacon_component-stroke_arrow-down"
