  import React from 'react';     export default () => (     <svg version="1.1" id="cloudRainSunFill" className="climacon climacon_cloudRainSunFill" viewBox="15 15 70 70">
        <g className="climacon_iconWrap climacon_iconWrap-cloudRainSunFill">
            ...
            <g className="climacon_wrapperComponent climacon_wrapperComponent-rain">
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_rain climacon_component-stroke_rain- left"
                ...
                />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_rain climacon_component-stroke_rain- middle"
                ...
                />
                <path className="climacon_component climacon_component-stroke climacon_component-stroke_rain climacon_component-stroke_rain- right"
